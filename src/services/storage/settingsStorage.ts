...
import { DEFAULT_USER_SETTINGS, DEFAULT_API_CONFIG } from '../../types/settings'
...
export class SettingsStorage {
   ...
   */
  static updateSetting<K extends keyof UserSettings>(key: K, value: UserSettings[K]): UserSettings {
