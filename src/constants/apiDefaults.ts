...
export const ERROR_MESSAGES = {
  ...
  API_KEY_INVALID: 'The API key appears to be invalid. Please check and try again.',
  ...
  STORAGE_ERROR: 'Error saving to local storage. Your data may not be persisted.',
